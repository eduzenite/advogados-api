...
class AreasSeeder extends Seeder
{
    ...
    public function run()
    {
        Area::insert([
            ...
            ['name' => 'Direito Tributário', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ...
            ['name' => 'Direito da Tecnologia da Informação', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ...
            ['name' => 'Defensoria Pública', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
